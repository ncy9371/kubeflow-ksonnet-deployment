...
class KubeFormSpawner(KubeSpawner):
    ...
    <datalist id="image">
      ...
      <option value="ncy9371/tensorflow-1.9.0-notebook-cpu:v0">
      <option value="ncy9371/tensorflow-1.9.0-notebook-gpu:v0">
      <option value="ncy9371/tensorflow-1.10.1-notebook-cpu:v0">
      <option value="ncy9371/tensorflow-1.10.1-notebook-gpu:v0">
    </datalist>
    <br/><br/>
