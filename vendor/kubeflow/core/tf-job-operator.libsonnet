{
  all(params):: [
                  ...
                  $.parts(params.namespace).ui(params.tfJobUiImage),
                  $.parts(params.namespace).kubeArbitratorAccount,
                  $.parts(params.namespace).kubeArbitratorRole,
                  $.parts(params.namespace).kubeArbitratorRoleBinding,
                  $.parts(params.namespace).kubeArbitratorDeploy(params.kubeArbitratorImage),
                ] +
      ...
      spec: {
        ...
        template: {
          ...
          spec: {
            ...
            serviceAccountName: "kube-arbitrator",
          },
        },
      },
    },  // kubeArbitratorDeploy

    kubeArbitratorAccount: {
      apiVersion: "v1",
      kind: "ServiceAccount",
      metadata: {
